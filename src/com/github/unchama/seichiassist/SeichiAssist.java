...
public class SeichiAssist extends JavaPlugin {
    ...
    /** DB上でのサブホームポイント記録用データサイズ */
    //DB上でのサブホーム1つ辺りのデータサイズ xyz各10*3+ワールド名64+区切り文字1*4
    static final int SUB_HOME_DATASIZE = 98;

    /** DB上での妖精召喚時間のデータサイズ */
    //DB上での妖精を召喚した時間のデータサイズ 年4+月2+日2+時間2+分2+区切り文字1*5
    static final int VOTE_FAIRYTIME_DATASIZE = 17;
    ...
    private static final List<MineStackObj> minestacklistmine = new ArrayList<>(Arrays.asList(
    ...
    private static final List<MineStackObj> minestacklistdrop = new ArrayList<>(Arrays.asList(
            //以下モンスター+動物ドロップ
    ...
    private static final List<MineStackObj> minestacklistfarm = new ArrayList<>(Arrays.asList(
            //以下採掘で入手可能な農業系ブロック
    ...
    //保護を掛けて整地するワールドのリスト
    public static final List<String> rgSeichiWorldlist = Collections.singletonList(
            "world_SW_2"
    );
